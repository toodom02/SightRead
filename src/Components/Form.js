...
export class Form extends Component {
    state = {
        ...
        Keys: [ //Uses no-break spaces for label
            ...
            { id: 17, fifths: +4, label: "C# Minor", name: "C+1", img: EMcsm, value: true, mode: "minor", notes: ['A+0', 'B+1', 'C+1', 'D+1', 'E+0', 'F+1', 'G+1'] },
            { id: 18, fifths: +5, label: "G# Minor", name: "G+1", img: BMgsm, value: true, mode: "minor", notes: ['A+1', 'B+0', 'C+1', 'D+1', 'E+0', 'F+2', 'G+1'] },
